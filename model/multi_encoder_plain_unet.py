...
class MultiEncoderPlainUNet(nn.Module):
    def __init__(self, num_encoder, input_channels, num_classes, num_downsample, num_blocks_per_stage, 
                 deep_supervision=True, encoder_base_num_features=8, featmap_mul_downsample=2, **layer_args):
...
if __name__ == "__main__":
    ...
    unet = MultiEncoderPlainUNet(4, 1, 3, 5, 2, deep_supervision=True, **layer_args)
    unet = unet.cuda()
